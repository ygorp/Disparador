            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-8">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-xl font-bold text-white hidden md:block">Discador.net</span>
                        </div>
                        <nav class="hidden lg:flex items-center space-x-6">
                            <a href="<?php echo BASE_URL; ?>views/client/dashboard.php" class="<?= $current_page === 'dashboard' ? 'text-roxo-principal font-semibold border-b-2 border-roxo-principal pb-1' : 'text-gray-300 hover:text-white transition duration-200' ?>">
                                Dashboard
                            </a>
                            <a href="<?php echo BASE_URL; ?>views/client/instancias.php" class="<?= $current_page === 'instancias' ? 'text-roxo-principal font-semibold border-b-2 border-roxo-principal pb-1' : 'text-gray-300 hover:text-white transition duration-200' ?>">
                                Instâncias
                            </a>
                            <a href="<?php echo BASE_URL; ?>views/client/maturacao.php" class="<?= $current_page === 'maturacao' ? 'text-blue-400 font-semibold border-b-2 border-blue-400 pb-1' : 'text-gray-300 hover:text-white transition duration-200' ?>">
                                Maturação
                            </a>
                            ...
                            <a href="extrato.php" class="<?= $current_page === 'extrato' ? 'text-roxo-principal font-semibold border-b-2 border-roxo-principal pb-1' : 'text-gray-300 hover:text-white transition duration-200' ?>">
                                Extrato
                            </a>
                            <a href="tutorial.php" class="<?= $current_page === 'tutorial' ? 'text-roxo-principal font-semibold border-b-2 border-roxo-principal pb-1' : 'text-gray-300 hover:text-white transition duration-200' ?>">
                                Tutorial
                            </a>
                        </nav>
                    </div>
                        ...
                        <div class="relative">
                            <button id="user-menu-button" class="flex items-center space-x-2 focus:outline-none">
                                <div class="flex items-center space-x-2 bg-fundo-principal px-3 py-2 rounded-lg hover:bg-gray-700 transition">
                                    <div class="w-8 h-8 bg-roxo-principal rounded-full flex items-center justify-center">
                            ...
                            <div id="user-menu" class="absolute right-0 mt-2 w-56 bg-card-fundo rounded-lg shadow-xl py-2 hidden z-50 border border-gray-600">
                                ...
                                <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-fundo-principal hover:text-white transition">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="mobile-menu" class="lg:hidden mt-4 pb-4 border-t border-gray-600 hidden">
                    <div class="flex flex-col space-y-2 pt-4">
                        <a href="<?php echo BASE_URL; ?>views/client/dashboard.php" class="<?= $current_page === 'dashboard' ? 'text-roxo-principal font-semibold' : 'text-gray-300 hover:text-white' ?> block py-2">Dashboard</a>
                        <a href="<?php echo BASE_URL; ?>views/client/instancias.php" class="<?= $current_page === 'instancias' ? 'text-roxo-principal font-semibold' : 'text-gray-300 hover:text-white' ?> block py-2">Instâncias</a>
                        ...
                        <a href="extrato.php" class="<?= $current_page === 'extrato' ? 'text-roxo-principal font-semibold' : 'text-gray-300 hover:text-white' ?> block py-2">Extrato</a>
                        <a href="tutorial.php" class="<?= $current_page === 'tutorial' ? 'text-roxo-principal font-semibold' : 'text-gray-300 hover:text-white' ?> block py-2">Tutorial</a>
                    </div>
                </div>
            </div>
        </header>
