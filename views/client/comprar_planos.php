        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-6">
            <?php foreach ($planos_disparo as $plano): ?>
                <div class="bg-card-fundo rounded-xl p-8 text-center border-2 border-gray-700 hover:border-roxo-principal transition-all duration-300 transform hover:scale-105">
                    ...
                    <div class="mb-6">
                        <div class="text-5xl font-bold text-roxo-principal mb-2"><?= number_format($plano['creditos_disparo'], 0, ',', '.') ?></div>
                    ...
                    <button @click="openPurchaseModal(<?= htmlspecialchars(json_encode($plano)) ?>, 'disparo')" 
                            class="w-full bg-roxo-principal text-white font-bold py-3 px-6 rounded-lg hover:bg-purple-600 transition duration-300 transform hover:scale-105">
                        Comprar Agora
                    </button>
