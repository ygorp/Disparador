...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-gradient-to-br from-roxo-principal to-purple-600 rounded-xl p-6 text-white">
            ...
            <div class="bg-card-fundo rounded-lg shadow-lg p-6">
                ...
                <?php else: ?>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-700">
                        <a href="disparos.php" class="text-sm text-roxo-principal hover:underline">Ver todas as campanhas →</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="mt-8 bg-gradient-to-r from-roxo-principal to-purple-600 rounded-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
            ...
            <div class="flex space-x-3">
                <a href="tutorial.php" class="bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg text-sm font-medium transition">
                    Ver Tutoriais
                </a>
                <a href="#" class="bg-white text-roxo-principal px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition">
                    Contatar Suporte
                </a>
            </div>
        </div>
