        ...
        <div class="bg-card-fundo rounded-lg shadow-xl p-8">
            ...
            <form action="../src/controllers/login_controller.php" method="POST">
                ...
                <div class="flex items-center justify-end mb-6">
                    <a href="client/esqueci_senha.php" class="text-sm text-roxo-principal hover:underline">Esqueceu a senha?</a>
                </div>

                <div class="mb-4">
                    <button type="submit"
                            class="w-full bg-roxo-principal text-white font-bold py-3 px-4 rounded-md hover:bg-purple-600 transition duration-300">
                        Acessar
                    </button>
                </div>
                ...
                <div>
                     <button type="button" onclick="location.href='client/cadastro.php'"
                            class="w-full bg-laranja-acento text-white font-bold py-3 px-4 rounded-md hover:bg-orange-600 transition duration-300">
                        Me cadastrar
                    </button>
                </div>
            </form>
